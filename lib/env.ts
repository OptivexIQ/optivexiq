...
const envSchema = z.object({
  ...
  LEMONSQUEEZY_STARTER_USD_VARIANT_ID: z.string().optional(),
  LEMONSQUEEZY_STARTER_GBP_VARIANT_ID: z.string().optional(),
  LEMONSQUEEZY_PRO_VARIANT_ID: z.string().optional(),
  LEMONSQUEEZY_PRO_USD_VARIANT_ID: z.string().optional(),
  LEMONSQUEEZY_PRO_GBP_VARIANT_ID: z.string().optional(),
  LEMONSQUEEZY_GROWTH_VARIANT_ID: z.string().optional(),
  LEMONSQUEEZY_GROWTH_USD_VARIANT_ID: z.string().optional(),
  LEMONSQUEEZY_GROWTH_GBP_VARIANT_ID: z.string().optional(),
...
export const LEMONSQUEEZY_STARTER_USD_VARIANT_ID =
  env.LEMONSQUEEZY_STARTER_USD_VARIANT_ID;
export const LEMONSQUEEZY_STARTER_GBP_VARIANT_ID =
  env.LEMONSQUEEZY_STARTER_GBP_VARIANT_ID;
export const LEMONSQUEEZY_PRO_VARIANT_ID = env.LEMONSQUEEZY_PRO_VARIANT_ID;
export const LEMONSQUEEZY_PRO_USD_VARIANT_ID =
  env.LEMONSQUEEZY_PRO_USD_VARIANT_ID;
export const LEMONSQUEEZY_PRO_GBP_VARIANT_ID =
  env.LEMONSQUEEZY_PRO_GBP_VARIANT_ID;
export const LEMONSQUEEZY_GROWTH_VARIANT_ID =
  env.LEMONSQUEEZY_GROWTH_VARIANT_ID;
export const LEMONSQUEEZY_GROWTH_USD_VARIANT_ID =
  env.LEMONSQUEEZY_GROWTH_USD_VARIANT_ID;
export const LEMONSQUEEZY_GROWTH_GBP_VARIANT_ID =
  env.LEMONSQUEEZY_GROWTH_GBP_VARIANT_ID;
