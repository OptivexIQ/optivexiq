...
import {
  extractUserNotesFromHistoryNotes,
  mapRewriteHistoryRecordToStudioVersion,
} from "@/features/rewrites/services/rewriteStudioHistoryMapper";
    ...
    <div className="flex w-full flex-col gap-6">
      <RewriteStudioView
        initialData={{
          ...
          historyVersions: rewriteHistory.map(mapRewriteHistoryRecordToStudioVersion),
        }}
      />
    </div>
  );
